  ...
  return (
    <div className="flex flex-col lg:flex-row xl:flex-row 2xl:flex-row mt-10 py-5 lg:px-10 xl:px-10 2xl:px-10 px-4">
      ...
      <div className="order-1 lg:order-2 xl:order-2 2xl:order-2 lg:px-14 xl:px-14 2xl:px-14 lg:w-1/2 xl:w-1/2 2xl:w-1/2 w-full flex-col justify-center ">
        <h1 className="text-2xl font-bold" style={{'color':'#e48c71'}} data-aos="fade-up">YOUR PERSONAL DATA IS SAFE WITH US</h1>
        <h1 className="font-bold mt-10 text-5xl" data-aos="flip-right">GOVT. ENSURES YOUR </h1>
        <h1 className="text-5xl font-bold " data-aos="flip-right">SAFETY FIRST</h1>
        <p className="font-bold mt-3 text-base " data-aos="flip-right">
        Govt. of India ensures the safety of your personal data and ensures that it is not misused.
        No one can access your personal data without your permission. Only you can access your data.
        </p>
        <p className="font-bold mt-3 text-base " data-aos="flip-right">
        </p>
        <a
